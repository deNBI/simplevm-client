...
This document describes the technical requirements a new site must meet in order to be connected to a SimpleVM application.
...
- Flavor definitions must adhere to those defined by the central application.
...
### OpenStack Flavor Exporter

- Optionally, the cloud site can install the OpenStack Flavor Exporter, which allows checking which flavors are currently available.
- Repository: [https://gitlab.ub.uni-bielefeld.de/denbi/OpenStackFlavorExporter](https://gitlab.ub.uni-bielefeld.de/denbi/OpenStackFlavorExporter)
