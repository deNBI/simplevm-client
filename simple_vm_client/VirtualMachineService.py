    ...
    def write(self, oprot):
        ...
        if self.volume_ids is not None:
            ...
            for iter102 in self.volume_ids:
                oprot.writeString(
                    iter102.encode("utf-8") if sys.version_info[0] == 2 else iter102
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter155, viter156 in self.metadata.items():
                oprot.writeString(
                    kiter155.encode("utf-8") if sys.version_info[0] == 2 else kiter155
                )
                oprot.writeString(
                    viter156.encode("utf-8") if sys.version_info[0] == 2 else viter156
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.volume_ids_path_new is not None:
            ...
            for iter157 in self.volume_ids_path_new:
                ...
                for kiter158, viter159 in iter157.items():
                    oprot.writeString(
                        kiter158.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter158
                    )
                    oprot.writeString(
                        viter159.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter159
                    )
                oprot.writeMapEnd()
        ...
        if self.volume_ids_path_attach is not None:
            ...
            for iter160 in self.volume_ids_path_attach:
                ...
                for kiter161, viter162 in iter160.items():
                    oprot.writeString(
                        kiter161.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter161
                    )
                    oprot.writeString(
                        viter162.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter162
                    )
                oprot.writeMapEnd()
        ...
        if self.additional_keys is not None:
            ...
            for iter163 in self.additional_keys:
                oprot.writeString(
                    iter163.encode("utf-8") if sys.version_info[0] == 2 else iter163
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.additional_security_group_ids is not None:
            ...
            for iter164 in self.additional_security_group_ids:
                oprot.writeString(
                    iter164.encode("utf-8") if sys.version_info[0] == 2 else iter164
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter204, viter205 in self.metadata.items():
                oprot.writeString(
                    kiter204.encode("utf-8") if sys.version_info[0] == 2 else kiter204
                )
                oprot.writeString(
                    viter205.encode("utf-8") if sys.version_info[0] == 2 else viter205
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.research_environment is not None:
        ...
        if self.volume_ids_path_new is not None:
            ...
            for iter206 in self.volume_ids_path_new:
                ...
                for kiter207, viter208 in iter206.items():
                    oprot.writeString(
                        kiter207.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter207
                    )
                    oprot.writeString(
                        viter208.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter208
                    )
                oprot.writeMapEnd()
        ...
        if self.volume_ids_path_attach is not None:
            ...
            for iter209 in self.volume_ids_path_attach:
                ...
                for kiter210, viter211 in iter209.items():
                    oprot.writeString(
                        kiter210.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter210
                    )
                    oprot.writeString(
                        viter211.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter211
                    )
                oprot.writeMapEnd()
    ...
    def write(self, oprot):
        ...
        if self.apt_packages is not None:
            ...
            for iter226 in self.apt_packages:
                oprot.writeString(
                    iter226.encode("utf-8") if sys.version_info[0] == 2 else iter226
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter255, viter256 in self.success.items():
                oprot.writeString(
                    kiter255.encode("utf-8") if sys.version_info[0] == 2 else kiter255
                )
                oprot.writeString(
                    viter256.encode("utf-8") if sys.version_info[0] == 2 else viter256
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.b is not None:
    ...
    def write(self, oprot):
        ...
        if self.server_ids is not None:
            ...
            for iter293 in self.server_ids:
                oprot.writeString(
                    iter293.encode("utf-8") if sys.version_info[0] == 2 else iter293
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter328, viter329 in self.success.items():
                oprot.writeString(
                    kiter328.encode("utf-8") if sys.version_info[0] == 2 else kiter328
                )
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter338, viter339 in self.success.items():
                oprot.writeString(
                    kiter338.encode("utf-8") if sys.version_info[0] == 2 else kiter338
                )
                oprot.writeString(
                    viter339.encode("utf-8") if sys.version_info[0] == 2 else viter339
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.c is not None:
    ...
    def write(self, oprot):
        ...
        if self.public_keys is not None:
            ...
            for iter368 in self.public_keys:
                oprot.writeString(
                    iter368.encode("utf-8") if sys.version_info[0] == 2 else iter368
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter377, viter378 in self.success.items():
                oprot.writeString(
                    kiter377.encode("utf-8") if sys.version_info[0] == 2 else kiter377
                )
                oprot.writeString(
                    viter378.encode("utf-8") if sys.version_info[0] == 2 else viter378
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter386, viter387 in self.success.items():
                ...
                oprot.writeString(
                    viter387.encode("utf-8") if sys.version_info[0] == 2 else viter387
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.c is not None:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter404, viter405 in self.metadata.items():
                oprot.writeString(
                    kiter404.encode("utf-8") if sys.version_info[0] == 2 else kiter404
                )
                oprot.writeString(
                    viter405.encode("utf-8") if sys.version_info[0] == 2 else viter405
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter413, viter414 in self.metadata.items():
                oprot.writeString(
                    kiter413.encode("utf-8") if sys.version_info[0] == 2 else kiter413
                )
                oprot.writeString(
                    viter414.encode("utf-8") if sys.version_info[0] == 2 else viter414
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter422, viter423 in self.metadata.items():
                oprot.writeString(
                    kiter422.encode("utf-8") if sys.version_info[0] == 2 else kiter422
                )
                oprot.writeString(
                    viter423.encode("utf-8") if sys.version_info[0] == 2 else viter423
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
