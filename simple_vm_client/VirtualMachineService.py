            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i372 in range(_size368):
                        ...
                        _val374 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter375, viter376 in self.success.items():
                ...
                oprot.writeString(viter376.encode('utf-8') if sys.version_info[0] == 2 else viter376)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.c is not None:
            oprot.writeFieldBegin('c', TType.STRUCT, 1)
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i381 in range(_size377):
                        ...
                        self.base_tags.append(_elem382)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter391, viter392 in self.success.items():
                ...
                oprot.writeString(viter392.encode('utf-8') if sys.version_info[0] == 2 else viter392)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class start_cluster_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i397 in range(_size393):
                        ...
                        self.public_keys.append(_elem398)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i403 in range(_size399):
                        _elem404 = ClusterInstance()
                        _elem404.read(iprot)
                        self.worker_instances.append(_elem404)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.public_keys is not None:
            ...
            for iter405 in self.public_keys:
        ...
        if self.worker_instances is not None:
            ...
            for iter406 in self.worker_instances:
                iter406.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class create_volume_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i438 in range(_size434):
                        _key439 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val440 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.metadata[_key439] = _val440
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter441, viter442 in self.metadata.items():
...
class create_volume_by_source_volume_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i447 in range(_size443):
                        _key448 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val449 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.metadata[_key448] = _val449
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter450, viter451 in self.metadata.items():
...
class create_volume_by_volume_snap_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i456 in range(_size452):
                        _key457 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val458 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.metadata[_key457] = _val458
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter459, viter460 in self.metadata.items():
