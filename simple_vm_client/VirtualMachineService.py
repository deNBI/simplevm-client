...
class Iface(object):
    ...
    def start_server_with_custom_key(self, flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids, additional_keys, metadata_token, metadata_endpoint):
        """
...
class Client(Iface):
    ...
    def start_server_with_custom_key(self, flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids, additional_keys, metadata_token, metadata_endpoint):
        ...
        """
        self.send_start_server_with_custom_key(flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids, additional_keys, metadata_token, metadata_endpoint)
        return self.recv_start_server_with_custom_key()

    def send_start_server_with_custom_key(self, flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids, additional_keys, metadata_token, metadata_endpoint):
...
class Processor(Iface, TProcessor):
    ...
    def process_start_server_with_custom_key(self, seqid, iprot, oprot):
        ...
        result = start_server_with_custom_key_result()
        try:
            result.success = self._handler.start_server_with_custom_key(args.flavor_name, args.image_name, args.servername, args.metadata, args.research_environment, args.volume_ids_path_new, args.volume_ids_path_attach, args.additional_security_group_ids, args.additional_keys, args.metadata_token, args.metadata_endpoint)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except NameAlreadyUsedException as e:
...
class start_server_with_custom_key_args(object):
    ...
    def __init__(self, flavor_name=None, image_name=None, servername=None, metadata=None, research_environment=None, volume_ids_path_new=None, volume_ids_path_attach=None, additional_security_group_ids=None, additional_keys=None, metadata_token=None, metadata_endpoint=None,):
        self.flavor_name = flavor_name
        self.image_name = image_name
        self.servername = servername
        self.metadata = metadata
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i224 in range(_size220):
                        ...
                        self.additional_keys.append(_elem225)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 11:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter226, viter227 in self.metadata.items():
        ...
        if self.volume_ids_path_attach is not None:
            oprot.writeFieldBegin('volume_ids_path_attach', TType.LIST, 8)
            oprot.writeListBegin(TType.MAP, len(self.volume_ids_path_attach))
            for iter231 in self.volume_ids_path_attach:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter231))
        ...
        if self.additional_security_group_ids is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.additional_security_group_ids))
            for iter234 in self.additional_security_group_ids:
        ...
        if self.additional_keys is not None:
            ...
            oprot.writeFieldEnd()
        if self.metadata_token is not None:
            oprot.writeFieldBegin('metadata_token', TType.STRING, 11)
            oprot.writeString(self.metadata_token.encode('utf-8') if sys.version_info[0] == 2 else self.metadata_token)
            oprot.writeFieldEnd()
        if self.metadata_endpoint is not None:
            oprot.writeFieldBegin('metadata_endpoint', TType.STRING, 12)
            oprot.writeString(self.metadata_endpoint.encode('utf-8') if sys.version_info[0] == 2 else self.metadata_endpoint)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
start_server_with_custom_key_args.thrift_spec = (
    ...
    (11, TType.STRING, 'metadata_token', 'UTF8', None, ),  # 11
    (12, TType.STRING, 'metadata_endpoint', 'UTF8', None, ),  # 12
)
...
class create_and_deploy_playbook_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i240 in range(_size236):
                        _elem241 = CondaPackage()
                        _elem241.read(iprot)
                        self.conda_packages.append(_elem241)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i246 in range(_size242):
                        ...
                        self.apt_packages.append(_elem247)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.conda_packages is not None:
            ...
            for iter248 in self.conda_packages:
                iter248.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.apt_packages is not None:
            ...
            for iter249 in self.apt_packages:
...
class delete_user_from_backend_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.success))
            for kiter294, viter295 in self.success.items():
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i300 in range(_size296):
                        _elem301 = ResearchEnvironmentTemplate()
                        _elem301.read(iprot)
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i314 in range(_size310):
                        ...
                        self.server_ids.append(_elem315)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter351, viter352 in self.success.items():
                ...
                oprot.writeListBegin(TType.STRING, len(viter352))
                for iter353 in viter352:
...
class get_cluster_status_result(object):
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i358 in range(_size354):
                        ...
                        _val360 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.success[_key359] = _val360
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 1:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.success))
            for kiter361, viter362 in self.success.items():
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i367 in range(_size363):
                        ...
                        self.base_tags.append(_elem368)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
...
class start_cluster_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i383 in range(_size379):
                        ...
                        self.public_keys.append(_elem384)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i389 in range(_size385):
                        _elem390 = ClusterInstance()
                        _elem390.read(iprot)
                        self.worker_instances.append(_elem390)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.public_keys is not None:
            ...
            for iter391 in self.public_keys:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter400, viter401 in self.success.items():
                ...
                oprot.writeString(viter401.encode('utf-8') if sys.version_info[0] == 2 else viter401)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i406 in range(_size402):
                        _key407 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val408 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i415 in range(_size411):
                        ...
                        _val417 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
...
class create_volume_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i424 in range(_size420):
                        _key425 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val426 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.metadata[_key425] = _val426
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter427, viter428 in self.metadata.items():
...
class create_volume_by_source_volume_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i433 in range(_size429):
                        _key434 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val435 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.metadata[_key434] = _val435
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter436, viter437 in self.metadata.items():
                oprot.writeString(kiter436.encode('utf-8') if sys.version_info[0] == 2 else kiter436)
                oprot.writeString(viter437.encode('utf-8') if sys.version_info[0] == 2 else viter437)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class create_volume_by_volume_snap_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter445, viter446 in self.metadata.items():
