...
class Iface(object):
    ...
    def start_server(self, flavor_name, image_name, public_key, servername, metadata, volume_ids_path_new, volume_ids_path_attach, additional_owner_keys, additional_user_keys, research_environment, additional_security_group_ids, slurm_version, metadata_token, metadata_endpoint, additional_script):
        """
        Parameters:
    ...
    def start_server_with_custom_key(self, flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids, additional_owner_keys, additional_user_keys, metadata_token, metadata_endpoint, additional_script):
        """
    ...
    def get_cluster_supported_ubuntu_os_versions(self):
        pass
    ...
    def get_cluster_log(self, cluster_id):
        """
        Parameters:
         - cluster_id
    ...
    def get_server_by_unique_name(self, unique_name, no_connection):
        """
        Parameters:
    ...
    def start_cluster(self, public_keys, master_instance, worker_instances, metadata, shared_volume):
        """
        Parameters:
         - public_keys
         - master_instance
...
class Client(Iface):
    ...
    def add_project_security_group_to_server(self, server_id, project_name, project_id):
        ...
        """
        self.send_add_project_security_group_to_server(server_id, project_name, project_id)
        self.recv_add_project_security_group_to_server()

    def send_add_project_security_group_to_server(self, server_id, project_name, project_id):
        self._oprot.writeMessageBegin('add_project_security_group_to_server', TMessageType.CALL, self._seqid)
    ...
    def recv_add_project_security_group_to_server(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = add_project_security_group_to_server_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.r is not None:
            raise result.r
    ...
    def start_server(self, flavor_name, image_name, public_key, servername, metadata, volume_ids_path_new, volume_ids_path_attach, additional_owner_keys, additional_user_keys, research_environment, additional_security_group_ids, slurm_version, metadata_token, metadata_endpoint, additional_script):
        ...
        """
        self.send_start_server(flavor_name, image_name, public_key, servername, metadata, volume_ids_path_new, volume_ids_path_attach, additional_owner_keys, additional_user_keys, research_environment, additional_security_group_ids, slurm_version, metadata_token, metadata_endpoint, additional_script)
        return self.recv_start_server()

    def send_start_server(self, flavor_name, image_name, public_key, servername, metadata, volume_ids_path_new, volume_ids_path_attach, additional_owner_keys, additional_user_keys, research_environment, additional_security_group_ids, slurm_version, metadata_token, metadata_endpoint, additional_script):
    ...
    def start_server_with_custom_key(self, flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids, additional_owner_keys, additional_user_keys, metadata_token, metadata_endpoint, additional_script):
        ...
        """
        self.send_start_server_with_custom_key(flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids, additional_owner_keys, additional_user_keys, metadata_token, metadata_endpoint, additional_script)
        return self.recv_start_server_with_custom_key()

    def send_start_server_with_custom_key(self, flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids, additional_owner_keys, additional_user_keys, metadata_token, metadata_endpoint, additional_script):
    ...
    def send_get_forc_access_url(self):
        self._oprot.writeMessageBegin('get_forc_access_url', TMessageType.CALL, self._seqid)
    ...
    def recv_get_forc_access_url(self):
        ...
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "get_forc_access_url failed: unknown result")
    ...
    def recv_is_metadata_server_available(self):
        ...
        if result.b is not None:
            raise result.b
        raise TApplicationException(TApplicationException.MISSING_RESULT, "is_metadata_server_available failed: unknown result")
    ...
    def activate_auth_for_backend(self, backend_id):
        ...
        self.recv_activate_auth_for_backend()

    def send_activate_auth_for_backend(self, backend_id):
        self._oprot.writeMessageBegin('activate_auth_for_backend', TMessageType.CALL, self._seqid)
    ...
    def deactivate_auth_for_backend(self, backend_id):
        ...
        self.recv_deactivate_auth_for_backend()

    def send_deactivate_auth_for_backend(self, backend_id):
        self._oprot.writeMessageBegin('deactivate_auth_for_backend', TMessageType.CALL, self._seqid)
    ...
    def get_cluster_supported_ubuntu_os_versions(self):
        self.send_get_cluster_supported_ubuntu_os_versions()
        return self.recv_get_cluster_supported_ubuntu_os_versions()

    def send_get_cluster_supported_ubuntu_os_versions(self):
        self._oprot.writeMessageBegin('get_cluster_supported_ubuntu_os_versions', TMessageType.CALL, self._seqid)
        args = get_cluster_supported_ubuntu_os_versions_args()
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_get_cluster_supported_ubuntu_os_versions(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = get_cluster_supported_ubuntu_os_versions_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "get_cluster_supported_ubuntu_os_versions failed: unknown result")
    ...
    def get_cluster_log(self, cluster_id):
        ...
        """
        self.send_get_cluster_log(cluster_id)
        return self.recv_get_cluster_log()

    def send_get_cluster_log(self, cluster_id):
        self._oprot.writeMessageBegin('get_cluster_log', TMessageType.CALL, self._seqid)
        args = get_cluster_log_args()
        args.cluster_id = cluster_id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_get_cluster_log(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
        ...
        if result.c is not None:
            raise result.c
        raise TApplicationException(TApplicationException.MISSING_RESULT, "get_cluster_log failed: unknown result")
    ...
    def get_cluster_state(self, cluster_id):
        ...
        """
        self.send_get_cluster_state(cluster_id)
        return self.recv_get_cluster_state()

    def send_get_cluster_state(self, cluster_id):
        self._oprot.writeMessageBegin('get_cluster_state', TMessageType.CALL, self._seqid)
        args = get_cluster_state_args()
        args.cluster_id = cluster_id
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_get_cluster_state(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = get_cluster_state_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        if result.c is not None:
            raise result.c
        raise TApplicationException(TApplicationException.MISSING_RESULT, "get_cluster_state failed: unknown result")
    ...
    def send_get_server_console(self, openstack_id):
        self._oprot.writeMessageBegin('get_server_console', TMessageType.CALL, self._seqid)
    ...
    def recv_get_server_console(self):
        ...
        if result.e is not None:
            raise result.e
        raise TApplicationException(TApplicationException.MISSING_RESULT, "get_server_console failed: unknown result")
    ...
    def get_server(self, openstack_id, no_connection):
        ...
        """
        self.send_get_server(openstack_id, no_connection)
        return self.recv_get_server()

    def send_get_server(self, openstack_id, no_connection):
        self._oprot.writeMessageBegin('get_server', TMessageType.CALL, self._seqid)
        args = get_server_args()
        args.openstack_id = openstack_id
        args.no_connection = no_connection
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()
    ...
    def get_server_by_unique_name(self, unique_name, no_connection):
        ...
        """
        self.send_get_server_by_unique_name(unique_name, no_connection)
        return self.recv_get_server_by_unique_name()

    def send_get_server_by_unique_name(self, unique_name, no_connection):
    ...
    def start_cluster(self, public_keys, master_instance, worker_instances, metadata, shared_volume):
        ...
        """
        self.send_start_cluster(public_keys, master_instance, worker_instances, metadata, shared_volume)
        return self.recv_start_cluster()

    def send_start_cluster(self, public_keys, master_instance, worker_instances, metadata, shared_volume):
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["add_project_security_group_to_server"] = Processor.process_add_project_security_group_to_server
        ...
        self._processMap["activate_auth_for_backend"] = Processor.process_activate_auth_for_backend
        self._processMap["deactivate_auth_for_backend"] = Processor.process_deactivate_auth_for_backend
        ...
        self._processMap["get_cluster_supported_ubuntu_os_versions"] = Processor.process_get_cluster_supported_ubuntu_os_versions
        ...
        self._processMap["get_cluster_log"] = Processor.process_get_cluster_log
        self._processMap["get_cluster_state"] = Processor.process_get_cluster_state
    ...
    def process_add_project_security_group_to_server(self, seqid, iprot, oprot):
        ...
        result = add_project_security_group_to_server_result()
        try:
            self._handler.add_project_security_group_to_server(args.server_id, args.project_name, args.project_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except DefaultException as r:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("add_project_security_group_to_server", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_start_server_with_custom_key(self, seqid, iprot, oprot):
        ...
        result = start_server_with_custom_key_result()
        try:
            result.success = self._handler.start_server_with_custom_key(args.flavor_name, args.image_name, args.servername, args.metadata, args.research_environment, args.volume_ids_path_new, args.volume_ids_path_attach, args.additional_security_group_ids, args.additional_owner_keys, args.additional_user_keys, args.metadata_token, args.metadata_endpoint, args.additional_script)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except NameAlreadyUsedException as e:
    ...
    def process_activate_auth_for_backend(self, seqid, iprot, oprot):
        ...
        result = activate_auth_for_backend_result()
        try:
            self._handler.activate_auth_for_backend(args.backend_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except BackendNotFoundException as b:
    ...
    def process_deactivate_auth_for_backend(self, seqid, iprot, oprot):
        ...
        result = deactivate_auth_for_backend_result()
        try:
            self._handler.deactivate_auth_for_backend(args.backend_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except BackendNotFoundException as b:
    ...
    def process_get_cluster_supported_ubuntu_os_versions(self, seqid, iprot, oprot):
        args = get_cluster_supported_ubuntu_os_versions_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = get_cluster_supported_ubuntu_os_versions_result()
        try:
            result.success = self._handler.get_cluster_supported_ubuntu_os_versions()
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("get_cluster_supported_ubuntu_os_versions", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_get_cluster_log(self, seqid, iprot, oprot):
        args = get_cluster_log_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = get_cluster_log_result()
        try:
            result.success = self._handler.get_cluster_log(args.cluster_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except ClusterNotFoundException as c:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("get_cluster_log", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_get_cluster_state(self, seqid, iprot, oprot):
        args = get_cluster_state_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = get_cluster_state_result()
        try:
            result.success = self._handler.get_cluster_state(args.cluster_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except ClusterNotFoundException as c:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("get_cluster_state", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_get_server(self, seqid, iprot, oprot):
        ...
        result = get_server_result()
        try:
            result.success = self._handler.get_server(args.openstack_id, args.no_connection)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except ServerNotFoundException as e:
    ...
    def process_get_server_by_unique_name(self, seqid, iprot, oprot):
        ...
        result = get_server_by_unique_name_result()
        try:
            result.success = self._handler.get_server_by_unique_name(args.unique_name, args.no_connection)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except ServerNotFoundException as e:
    ...
    def process_start_cluster(self, seqid, iprot, oprot):
        ...
        result = start_cluster_result()
        try:
            result.success = self._handler.start_cluster(args.public_keys, args.master_instance, args.worker_instances, args.metadata, args.shared_volume)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_terminate_cluster(self, seqid, iprot, oprot):
        ...
        result = terminate_cluster_result()
        try:
            self._handler.terminate_cluster(args.cluster_id)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except ClusterNotFoundException as c:
...
class add_project_security_group_to_server_args(object):
    """
    Attributes:
     - server_id: OpenStack id of the server
     - project_name
    ...
    def __init__(self, server_id=None, project_name=None, project_id=None,):
        self.server_id = server_id
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(add_project_security_group_to_server_args)
add_project_security_group_to_server_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'server_id', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'project_name', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'project_id', 'UTF8', None, ),  # 3
)


class add_project_security_group_to_server_result(object):
    """
    Attributes:
     - r
     - s
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('add_project_security_group_to_server_result')
        if self.r is not None:
            oprot.writeFieldBegin('r', TType.STRUCT, 1)
            self.r.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(add_project_security_group_to_server_result)
add_project_security_group_to_server_result.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'r', [DefaultException, None], None, ),  # 1
    (2, TType.STRUCT, 's', [ServerNotFoundException, None], None, ),  # 2
)
...
class start_server_args(object):
    ...
    def __init__(self, flavor_name=None, image_name=None, public_key=None, servername=None, metadata=None, volume_ids_path_new=None, volume_ids_path_attach=None, additional_owner_keys=None, additional_user_keys=None, research_environment=None, additional_security_group_ids=None, slurm_version=None, metadata_token=None, metadata_endpoint=None, additional_script=None,):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i163 in range(_size159):
                        ...
                        self.additional_owner_keys.append(_elem164)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i175 in range(_size171):
                        ...
                        self.additional_security_group_ids.append(_elem176)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 13:
                ...
                if ftype == TType.STRING:
                    self.additional_script = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter177, viter178 in self.metadata.items():
        ...
        if self.volume_ids_path_new is not None:
            ...
            for iter179 in self.volume_ids_path_new:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter179))
                for kiter180, viter181 in iter179.items():
        ...
        if self.volume_ids_path_attach is not None:
            ...
            for iter182 in self.volume_ids_path_attach:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter182))
                for kiter183, viter184 in iter182.items():
            ...
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.additional_owner_keys is not None:
            oprot.writeFieldBegin('additional_owner_keys', TType.LIST, 9)
            oprot.writeListBegin(TType.STRING, len(self.additional_owner_keys))
            for iter185 in self.additional_owner_keys:
        ...
        if self.research_environment is not None:
            oprot.writeFieldBegin('research_environment', TType.STRING, 11)
        ...
        if self.additional_security_group_ids is not None:
            oprot.writeFieldBegin('additional_security_group_ids', TType.LIST, 12)
            oprot.writeListBegin(TType.STRING, len(self.additional_security_group_ids))
            for iter187 in self.additional_security_group_ids:
        ...
        if self.metadata_token is not None:
            oprot.writeFieldBegin('metadata_token', TType.STRING, 14)
        ...
        if self.metadata_endpoint is not None:
            oprot.writeFieldBegin('metadata_endpoint', TType.STRING, 15)
        ...
        if self.additional_script is not None:
            ...
            oprot.writeString(self.additional_script.encode('utf-8') if sys.version_info[0] == 2 else self.additional_script)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
start_server_args.thrift_spec = (
    ...
    (9, TType.LIST, 'additional_owner_keys', (TType.STRING, 'UTF8', False), None, ),  # 9
    (10, TType.LIST, 'additional_user_keys', (TType.STRING, 'UTF8', False), None, ),  # 10
    (11, TType.STRING, 'research_environment', 'UTF8', None, ),  # 11
    (12, TType.LIST, 'additional_security_group_ids', (TType.STRING, 'UTF8', False), None, ),  # 12
    (13, TType.STRING, 'slurm_version', 'UTF8', None, ),  # 13
    (14, TType.STRING, 'metadata_token', 'UTF8', None, ),  # 14
    (15, TType.STRING, 'metadata_endpoint', 'UTF8', None, ),  # 15
    (16, TType.STRING, 'additional_script', 'UTF8', None, ),  # 16
)
...
class start_server_with_custom_key_args(object):
    ...
    def __init__(self, flavor_name=None, image_name=None, servername=None, metadata=None, research_environment=None, volume_ids_path_new=None, volume_ids_path_attach=None, additional_security_group_ids=None, additional_owner_keys=None, additional_user_keys=None, metadata_token=None, metadata_endpoint=None, additional_script=None,):
        self.flavor_name = flavor_name
        self.image_name = image_name
        self.servername = servername
        self.metadata = metadata
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i199 in range(_size195):
                        ...
                        for _i205 in range(_size201):
                            ...
                            _elem200[_key206] = _val207
                        iprot.readMapEnd()
                        self.volume_ids_path_new.append(_elem200)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.LIST:
                    ...
                    for _i212 in range(_size208):
                        ...
                        for _i218 in range(_size214):
                            _key219 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                            _val220 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                            _elem213[_key219] = _val220
                        iprot.readMapEnd()
                        self.volume_ids_path_attach.append(_elem213)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i225 in range(_size221):
                        ...
                        self.additional_security_group_ids.append(_elem226)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.LIST:
                    ...
                    for _i231 in range(_size227):
                        ...
                        self.additional_owner_keys.append(_elem232)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 11:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter239, viter240 in self.metadata.items():
        ...
        if self.volume_ids_path_new is not None:
            oprot.writeFieldBegin('volume_ids_path_new', TType.LIST, 7)
            oprot.writeListBegin(TType.MAP, len(self.volume_ids_path_new))
            for iter241 in self.volume_ids_path_new:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter241))
                for kiter242, viter243 in iter241.items():
        ...
        if self.volume_ids_path_attach is not None:
            oprot.writeFieldBegin('volume_ids_path_attach', TType.LIST, 8)
            oprot.writeListBegin(TType.MAP, len(self.volume_ids_path_attach))
            for iter244 in self.volume_ids_path_attach:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter244))
                for kiter245, viter246 in iter244.items():
        ...
        if self.additional_security_group_ids is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.additional_security_group_ids))
            for iter247 in self.additional_security_group_ids:
                oprot.writeString(iter247.encode('utf-8') if sys.version_info[0] == 2 else iter247)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.additional_owner_keys is not None:
            oprot.writeFieldBegin('additional_owner_keys', TType.LIST, 10)
            oprot.writeListBegin(TType.STRING, len(self.additional_owner_keys))
            for iter248 in self.additional_owner_keys:
        ...
        if self.additional_user_keys is not None:
            ...
            oprot.writeFieldEnd()
        if self.metadata_token is not None:
            oprot.writeFieldBegin('metadata_token', TType.STRING, 12)
            oprot.writeString(self.metadata_token.encode('utf-8') if sys.version_info[0] == 2 else self.metadata_token)
            oprot.writeFieldEnd()
        if self.metadata_endpoint is not None:
            oprot.writeFieldBegin('metadata_endpoint', TType.STRING, 13)
            oprot.writeString(self.metadata_endpoint.encode('utf-8') if sys.version_info[0] == 2 else self.metadata_endpoint)
            oprot.writeFieldEnd()
        if self.additional_script is not None:
...
start_server_with_custom_key_args.thrift_spec = (
    ...
    (10, TType.LIST, 'additional_owner_keys', (TType.STRING, 'UTF8', False), None, ),  # 10
    (11, TType.LIST, 'additional_user_keys', (TType.STRING, 'UTF8', False), None, ),  # 11
    (12, TType.STRING, 'metadata_token', 'UTF8', None, ),  # 12
    (13, TType.STRING, 'metadata_endpoint', 'UTF8', None, ),  # 13
    (14, TType.STRING, 'additional_script', 'UTF8', None, ),  # 14
)
...
class create_and_deploy_playbook_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i254 in range(_size250):
                        _elem255 = CondaPackage()
                        _elem255.read(iprot)
                        self.conda_packages.append(_elem255)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i260 in range(_size256):
                        ...
                        self.apt_packages.append(_elem261)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.conda_packages is not None:
            ...
            for iter262 in self.conda_packages:
                iter262.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.apt_packages is not None:
            ...
            for iter263 in self.apt_packages:
...
class is_metadata_server_available_result(object):
    ...
    def __init__(self, success=None, m=None, b=None,):
        self.success = success
        self.m = m
        self.b = b
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i305 in range(_size301):
                        _key306 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val307 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter308, viter309 in self.success.items():
                ...
                oprot.writeString(viter309.encode('utf-8') if sys.version_info[0] == 2 else viter309)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.b is not None:
            oprot.writeFieldBegin('b', TType.STRUCT, 1)
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i314 in range(_size310):
                        _elem315 = ResearchEnvironmentTemplate()
                        _elem315.read(iprot)
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i328 in range(_size324):
                        ...
                        self.server_ids.append(_elem329)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class get_cluster_supported_ubuntu_os_versions_args(object):
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_cluster_supported_ubuntu_os_versions_args')
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_cluster_supported_ubuntu_os_versions_args)
get_cluster_supported_ubuntu_os_versions_args.thrift_spec = (
)


class get_cluster_supported_ubuntu_os_versions_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_cluster_supported_ubuntu_os_versions_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRING, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_cluster_supported_ubuntu_os_versions_result)
get_cluster_supported_ubuntu_os_versions_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRING, 'UTF8', False), None, ),  # 0
)
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter372, viter373 in self.success.items():
                ...
                oprot.writeListBegin(TType.STRING, len(viter373))
                for iter374 in viter373:
...
class get_cluster_log_args(object):
    """
    Attributes:
     - cluster_id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_cluster_log_args')
        if self.cluster_id is not None:
            oprot.writeFieldBegin('cluster_id', TType.STRING, 1)
            oprot.writeString(self.cluster_id.encode('utf-8') if sys.version_info[0] == 2 else self.cluster_id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_cluster_log_args)
get_cluster_log_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'cluster_id', 'UTF8', None, ),  # 1
)


class get_cluster_log_result(object):
    """
    Attributes:
     - success
     - c
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_cluster_log_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_cluster_log_result)
get_cluster_log_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [ClusterLog, None], None, ),  # 0
    (1, TType.STRUCT, 'c', [ClusterNotFoundException, None], None, ),  # 1
)


class get_cluster_state_args(object):
    """
    Attributes:
     - cluster_id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_cluster_state_args')
        if self.cluster_id is not None:
            oprot.writeFieldBegin('cluster_id', TType.STRING, 1)
            oprot.writeString(self.cluster_id.encode('utf-8') if sys.version_info[0] == 2 else self.cluster_id)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_cluster_state_args)
get_cluster_state_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'cluster_id', 'UTF8', None, ),  # 1
)


class get_cluster_state_result(object):
    """
    Attributes:
     - success
     - c
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('get_cluster_state_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(get_cluster_state_result)
get_cluster_state_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [ClusterState, None], None, ),  # 0
    (1, TType.STRUCT, 'c', [ClusterNotFoundException, None], None, ),  # 1
)
...
class get_server_args(object):
    ...
    def __init__(self, openstack_id=None, no_connection=None,):
        self.openstack_id = openstack_id
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    self.no_connection = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.openstack_id is not None:
            ...
            oprot.writeString(self.openstack_id.encode('utf-8') if sys.version_info[0] == 2 else self.openstack_id)
            oprot.writeFieldEnd()
        if self.no_connection is not None:
            oprot.writeFieldBegin('no_connection', TType.BOOL, 2)
            oprot.writeBool(self.no_connection)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
get_server_args.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'openstack_id', 'UTF8', None, ),  # 1
    (2, TType.BOOL, 'no_connection', None, None, ),  # 2
)
...
class get_server_by_unique_name_args(object):
    ...
    def __init__(self, unique_name=None, no_connection=None,):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i379 in range(_size375):
                        ...
                        self.base_tags.append(_elem380)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
...
class start_cluster_args(object):
    ...
    def __init__(self, public_keys=None, master_instance=None, worker_instances=None, metadata=None, shared_volume=None,):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i395 in range(_size391):
                        ...
                        self.public_keys.append(_elem396)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i401 in range(_size397):
                        _elem402 = ClusterWorker()
                        _elem402.read(iprot)
                        self.worker_instances.append(_elem402)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.public_keys is not None:
            ...
            for iter403 in self.public_keys:
        ...
        if self.worker_instances is not None:
            ...
            for iter404 in self.worker_instances:
                iter404.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.metadata is not None:
...
start_cluster_args.thrift_spec = (
    ...
    (3, TType.LIST, 'worker_instances', (TType.STRUCT, [ClusterWorker, None], False), None, ),  # 3
    (4, TType.STRUCT, 'metadata', [ClusterInstanceMetadata, None], None, ),  # 4
    (5, TType.STRUCT, 'shared_volume', [ClusterVolume, None], None, ),  # 5
)
...
start_cluster_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [ClusterMessage, None], None, ),  # 0
)
...
class create_volume_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i418 in range(_size414):
                        ...
                        _val420 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.metadata[_key419] = _val420
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter421, viter422 in self.metadata.items():
...
class create_volume_by_source_volume_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter430, viter431 in self.metadata.items():
...
class create_volume_by_volume_snap_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter439, viter440 in self.metadata.items():
