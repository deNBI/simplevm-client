    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter81, viter82 in self.success.items():
                oprot.writeString(
                    kiter81.encode("utf-8") if sys.version_info[0] == 2 else kiter81
                )
                oprot.writeString(
                    viter82.encode("utf-8") if sys.version_info[0] == 2 else viter82
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter90, viter91 in self.success.items():
                oprot.writeString(
                    kiter90.encode("utf-8") if sys.version_info[0] == 2 else kiter90
                )
                oprot.writeString(
                    viter91.encode("utf-8") if sys.version_info[0] == 2 else viter91
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter99, viter100 in self.success.items():
                oprot.writeString(
                    kiter99.encode("utf-8") if sys.version_info[0] == 2 else kiter99
                )
                oprot.writeString(
                    viter100.encode("utf-8") if sys.version_info[0] == 2 else viter100
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class add_metadata_to_server_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter108, viter109 in self.metadata.items():
                oprot.writeString(
                    kiter108.encode("utf-8") if sys.version_info[0] == 2 else kiter108
                )
                oprot.writeString(
                    viter109.encode("utf-8") if sys.version_info[0] == 2 else viter109
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class get_volumes_by_ids_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i142 in range(_size138):
                        ...
                        self.volume_ids.append(_elem143)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.volume_ids is not None:
            ...
            for iter144 in self.volume_ids:
                oprot.writeString(
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i163 in range(_size159):
                        ...
                        for _i169 in range(_size165):
                            ...
                            _elem164[_key170] = _val171
                        iprot.readMapEnd()
                        self.volume_ids_path_new.append(_elem164)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.LIST:
                    ...
                    for _i176 in range(_size172):
                        ...
                        for _i182 in range(_size178):
                            ...
                            _elem177[_key183] = _val184
                        iprot.readMapEnd()
                        self.volume_ids_path_attach.append(_elem177)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i189 in range(_size185):
                        ...
                        self.additional_owner_keys.append(_elem190)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.LIST:
                    ...
                    for _i195 in range(_size191):
                        ...
                        self.additional_user_keys.append(_elem196)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 11:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i201 in range(_size197):
                        ...
                        self.additional_security_group_ids.append(_elem202)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 13:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter203, viter204 in self.metadata.items():
                oprot.writeString(
                    kiter203.encode("utf-8") if sys.version_info[0] == 2 else kiter203
                )
                oprot.writeString(
                    viter204.encode("utf-8") if sys.version_info[0] == 2 else viter204
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        ...
        if self.volume_ids_path_attach is not None:
            ...
            for iter208 in self.volume_ids_path_attach:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter208))
                for kiter209, viter210 in iter208.items():
                    oprot.writeString(
                        kiter209.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter209
                    )
                    oprot.writeString(
                        viter210.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter210
                    )
                oprot.writeMapEnd()
        ...
        if self.additional_owner_keys is not None:
            ...
            for iter211 in self.additional_owner_keys:
                oprot.writeString(
                    iter211.encode("utf-8") if sys.version_info[0] == 2 else iter211
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.additional_user_keys is not None:
            ...
            for iter212 in self.additional_user_keys:
                oprot.writeString(
                    iter212.encode("utf-8") if sys.version_info[0] == 2 else iter212
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.additional_security_group_ids is not None:
            ...
            for iter213 in self.additional_security_group_ids:
                oprot.writeString(
                    iter213.encode("utf-8") if sys.version_info[0] == 2 else iter213
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
get_health_status_result.thrift_spec = (
    (
        ...
        TType.MAP,
        "success",
        (TType.STRING, "UTF8", TType.STRUCT, [ComponentHealth, None], False),
        None,
    ),  # 0
)
...
class start_server_with_custom_key_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i234 in range(_size230):
                        ...
                        iprot.readMapEnd()
                        self.volume_ids_path_new.append(_elem235)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.LIST:
                    ...
                    for _i247 in range(_size243):
                        ...
                        for _i253 in range(_size249):
                            ...
                            _elem248[_key254] = _val255
                        iprot.readMapEnd()
                        self.volume_ids_path_attach.append(_elem248)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i260 in range(_size256):
                        ...
                        self.additional_security_group_ids.append(_elem261)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.LIST:
                    ...
                    for _i266 in range(_size262):
                        ...
                        self.additional_owner_keys.append(_elem267)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 11:
                if ftype == TType.LIST:
                    ...
                    for _i272 in range(_size268):
                        ...
                        self.additional_user_keys.append(_elem273)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
    ...
    def write(self, oprot):
        ...
        if self.volume_ids_path_attach is not None:
            oprot.writeFieldBegin("volume_ids_path_attach", TType.LIST, 8)
            oprot.writeListBegin(TType.MAP, len(self.volume_ids_path_attach))
            for iter279 in self.volume_ids_path_attach:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter279))
                for kiter280, viter281 in iter279.items():
                    oprot.writeString(
                        kiter280.encode("utf-8")
                        if sys.version_info[0] == 2
                        else kiter280
                    )
                    oprot.writeString(
                        viter281.encode("utf-8")
                        if sys.version_info[0] == 2
                        else viter281
                    )
                oprot.writeMapEnd()
        ...
        if self.additional_security_group_ids is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.additional_security_group_ids))
            for iter282 in self.additional_security_group_ids:
                oprot.writeString(
        ...
        if self.additional_owner_keys is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.additional_owner_keys))
            for iter283 in self.additional_owner_keys:
                oprot.writeString(
                    iter283.encode("utf-8") if sys.version_info[0] == 2 else iter283
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.additional_user_keys is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.additional_user_keys))
            for iter284 in self.additional_user_keys:
                oprot.writeString(
...
class create_and_deploy_playbook_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i289 in range(_size285):
                        _elem290 = CondaPackage()
                        _elem290.read(iprot)
                        self.conda_packages.append(_elem290)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i295 in range(_size291):
                        ...
                        self.apt_packages.append(_elem296)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.conda_packages is not None:
            ...
            for iter297 in self.conda_packages:
                iter297.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.apt_packages is not None:
            ...
            for iter298 in self.apt_packages:
                oprot.writeString(
                    iter298.encode("utf-8") if sys.version_info[0] == 2 else iter298
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter327, viter328 in self.success.items():
                oprot.writeString(
                    kiter327.encode("utf-8") if sys.version_info[0] == 2 else kiter327
                )
                oprot.writeString(
                    viter328.encode("utf-8") if sys.version_info[0] == 2 else viter328
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.b is not None:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter335 in self.success:
                oprot.writeString(
                    iter335.encode("utf-8") if sys.version_info[0] == 2 else iter335
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.b is not None:
...
class delete_user_from_backend_result(object):
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            oprot.writeFieldBegin("success", TType.MAP, 0)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.success))
            for kiter343, viter344 in self.success.items():
                oprot.writeString(
                    kiter343.encode("utf-8") if sys.version_info[0] == 2 else kiter343
                )
                oprot.writeString(
                    viter344.encode("utf-8") if sys.version_info[0] == 2 else viter344
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.b is not None:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i349 in range(_size345):
                        _elem350 = ResearchEnvironmentTemplate()
                        _elem350.read(iprot)
...
class get_servers_by_ids_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i363 in range(_size359):
                        ...
                        self.server_ids.append(_elem364)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.server_ids is not None:
            ...
            for iter365 in self.server_ids:
                oprot.writeString(
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for iter379 in self.success:
                oprot.writeString(
                    iter379.encode("utf-8") if sys.version_info[0] == 2 else iter379
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter407, viter408 in self.success.items():
                oprot.writeString(
                    kiter407.encode("utf-8") if sys.version_info[0] == 2 else kiter407
                )
                oprot.writeListBegin(TType.STRING, len(viter408))
                for iter409 in viter408:
                    oprot.writeString(
                        iter409.encode("utf-8") if sys.version_info[0] == 2 else iter409
                    )
                oprot.writeListEnd()
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i414 in range(_size410):
                        ...
                        self.base_tags.append(_elem415)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter424, viter425 in self.success.items():
                oprot.writeString(
                    kiter424.encode("utf-8") if sys.version_info[0] == 2 else kiter424
                )
                oprot.writeString(
                    viter425.encode("utf-8") if sys.version_info[0] == 2 else viter425
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class start_cluster_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i437 in range(_size433):
                        ...
                        self.public_keys.append(_elem438)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i443 in range(_size439):
                        _elem444 = ClusterInstance()
                        _elem444.read(iprot)
                        self.worker_instances.append(_elem444)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.public_keys is not None:
            ...
            for iter445 in self.public_keys:
                oprot.writeString(
                    iter445.encode("utf-8") if sys.version_info[0] == 2 else iter445
                )
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.worker_instances is not None:
            ...
            for iter446 in self.worker_instances:
                iter446.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.metadata is not None:
...
class create_volume_by_volume_snap_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin("metadata", TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter481, viter482 in self.metadata.items():
                oprot.writeString(
                    kiter481.encode("utf-8") if sys.version_info[0] == 2 else kiter481
                )
                oprot.writeString(
                    viter482.encode("utf-8") if sys.version_info[0] == 2 else viter482
                )
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
