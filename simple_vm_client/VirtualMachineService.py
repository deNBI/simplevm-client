...
class Iface(object):
    ...
    def start_server(self, flavor_name, image_name, public_key, servername, metadata, volume_ids_path_new, volume_ids_path_attach, additional_keys, research_environment, additional_security_group_ids, slurm_version):
        """
        Parameters:
    ...
    def start_server_with_custom_key(self, flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids):
        """
...
class Client(Iface):
    ...
    def start_server(self, flavor_name, image_name, public_key, servername, metadata, volume_ids_path_new, volume_ids_path_attach, additional_keys, research_environment, additional_security_group_ids, slurm_version):
        ...
        """
        self.send_start_server(flavor_name, image_name, public_key, servername, metadata, volume_ids_path_new, volume_ids_path_attach, additional_keys, research_environment, additional_security_group_ids, slurm_version)
        return self.recv_start_server()

    def send_start_server(self, flavor_name, image_name, public_key, servername, metadata, volume_ids_path_new, volume_ids_path_attach, additional_keys, research_environment, additional_security_group_ids, slurm_version):
    ...
    def start_server_with_custom_key(self, flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids):
        ...
        """
        self.send_start_server_with_custom_key(flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids)
        return self.recv_start_server_with_custom_key()

    def send_start_server_with_custom_key(self, flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids):
...
class Processor(Iface, TProcessor):
    ...
    def process_start_server(self, seqid, iprot, oprot):
        ...
        result = start_server_result()
        try:
            result.success = self._handler.start_server(args.flavor_name, args.image_name, args.public_key, args.servername, args.metadata, args.volume_ids_path_new, args.volume_ids_path_attach, args.additional_keys, args.research_environment, args.additional_security_group_ids, args.slurm_version)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
    ...
    def process_start_server_with_custom_key(self, seqid, iprot, oprot):
        ...
        result = start_server_with_custom_key_result()
        try:
            result.success = self._handler.start_server_with_custom_key(args.flavor_name, args.image_name, args.servername, args.metadata, args.research_environment, args.volume_ids_path_new, args.volume_ids_path_attach, args.additional_security_group_ids)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except NameAlreadyUsedException as e:
...
class add_metadata_to_server_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            for kiter66, viter67 in self.metadata.items():
...
class get_volumes_by_ids_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i100 in range(_size96):
                        ...
                        self.volume_ids.append(_elem101)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.volume_ids is not None:
            ...
            for iter102 in self.volume_ids:
...
class start_server_args(object):
    ...
    def __init__(self, flavor_name=None, image_name=None, public_key=None, servername=None, metadata=None, volume_ids_path_new=None, volume_ids_path_attach=None, additional_keys=None, research_environment=None, additional_security_group_ids=None, slurm_version=None,):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i121 in range(_size117):
                        ...
                        for _i127 in range(_size123):
                            ...
                            _elem122[_key128] = _val129
                        iprot.readMapEnd()
                        self.volume_ids_path_new.append(_elem122)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.LIST:
                    ...
                    for _i134 in range(_size130):
                        ...
                        for _i140 in range(_size136):
                            ...
                            _elem135[_key141] = _val142
                        iprot.readMapEnd()
                        self.volume_ids_path_attach.append(_elem135)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i147 in range(_size143):
                        ...
                        self.additional_keys.append(_elem148)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i153 in range(_size149):
                        ...
                        self.additional_security_group_ids.append(_elem154)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter155, viter156 in self.metadata.items():
        ...
        if self.volume_ids_path_new is not None:
            ...
            for iter157 in self.volume_ids_path_new:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter157))
                for kiter158, viter159 in iter157.items():
                    oprot.writeString(kiter158.encode('utf-8') if sys.version_info[0] == 2 else kiter158)
                    oprot.writeString(viter159.encode('utf-8') if sys.version_info[0] == 2 else viter159)
                oprot.writeMapEnd()
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.volume_ids_path_attach is not None:
            ...
            for iter160 in self.volume_ids_path_attach:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter160))
                for kiter161, viter162 in iter160.items():
        ...
        if self.additional_security_group_ids is not None:
            ...
            for iter164 in self.additional_security_group_ids:
...
class start_server_with_custom_key_args(object):
    ...
    def __init__(self, flavor_name=None, image_name=None, servername=None, metadata=None, research_environment=None, volume_ids_path_new=None, volume_ids_path_attach=None, additional_security_group_ids=None,):
        self.flavor_name = flavor_name
        self.image_name = image_name
        self.servername = servername
        self.metadata = metadata
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i176 in range(_size172):
                        ...
                        iprot.readMapEnd()
                        self.volume_ids_path_new.append(_elem177)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                if ftype == TType.LIST:
                    ...
                    for _i189 in range(_size185):
                        ...
                        iprot.readMapEnd()
                        self.volume_ids_path_attach.append(_elem190)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i202 in range(_size198):
                        ...
                        self.additional_security_group_ids.append(_elem203)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter204, viter205 in self.metadata.items():
        ...
        if self.volume_ids_path_new is not None:
            ...
            for iter206 in self.volume_ids_path_new:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter206))
                for kiter207, viter208 in iter206.items():
        ...
        if self.volume_ids_path_attach is not None:
            ...
            for iter209 in self.volume_ids_path_attach:
                oprot.writeMapBegin(TType.STRING, TType.STRING, len(iter209))
                for kiter210, viter211 in iter209.items():
        ...
        if self.additional_security_group_ids is not None:
            ...
            oprot.writeListBegin(TType.STRING, len(self.additional_security_group_ids))
            for iter212 in self.additional_security_group_ids:
...
class create_and_deploy_playbook_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i217 in range(_size213):
                        _elem218 = CondaPackage()
                        _elem218.read(iprot)
                        self.conda_packages.append(_elem218)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i223 in range(_size219):
                        ...
                        self.apt_packages.append(_elem224)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.conda_packages is not None:
            ...
            for iter225 in self.conda_packages:
                iter225.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.apt_packages is not None:
            ...
            for iter226 in self.apt_packages:
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i277 in range(_size273):
                        _elem278 = ResearchEnvironmentTemplate()
                        _elem278.read(iprot)
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i291 in range(_size287):
                        ...
                        self.server_ids.append(_elem292)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.success is not None:
            ...
            for kiter328, viter329 in self.success.items():
                ...
                oprot.writeListBegin(TType.STRING, len(viter329))
                for iter330 in viter329:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i344 in range(_size340):
                        ...
                        self.base_tags.append(_elem345)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
...
class start_cluster_args(object):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i360 in range(_size356):
                        ...
                        self.public_keys.append(_elem361)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i366 in range(_size362):
                        _elem367 = ClusterInstance()
                        _elem367.read(iprot)
                        self.worker_instances.append(_elem367)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.public_keys is not None:
            ...
            for iter368 in self.public_keys:
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i383 in range(_size379):
                        _key384 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val385 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
            ...
            if fid == 0:
                if ftype == TType.MAP:
                    ...
                    for _i392 in range(_size388):
                        ...
                        _val394 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
...
class create_volume_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i401 in range(_size397):
                        ...
                        _val403 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.metadata[_key402] = _val403
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter404, viter405 in self.metadata.items():
...
class create_volume_by_source_volume_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i410 in range(_size406):
                        _key411 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val412 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.metadata[_key411] = _val412
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter413, viter414 in self.metadata.items():
...
class create_volume_by_volume_snap_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i419 in range(_size415):
                        _key420 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val421 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.metadata[_key420] = _val421
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter422, viter423 in self.metadata.items():
                oprot.writeString(kiter422.encode('utf-8') if sys.version_info[0] == 2 else kiter422)
                oprot.writeString(viter423.encode('utf-8') if sys.version_info[0] == 2 else viter423)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
