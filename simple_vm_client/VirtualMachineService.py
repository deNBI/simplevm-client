...
class Iface(object):
    ...
    def start_server(self, flavor_name, image_name, public_key, servername, metadata, volume_ids_path_new, volume_ids_path_attach, additional_owner_keys, additional_user_keys, research_environment, additional_security_group_ids, slurm_version, metadata_token, metadata_endpoint):
        """
        Parameters:
    ...
    def start_server_with_custom_key(self, flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids, additional_owner_keys, additional_user_keys, metadata_token, metadata_endpoint):
        """
...
class Client(Iface):
    ...
    def start_server(self, flavor_name, image_name, public_key, servername, metadata, volume_ids_path_new, volume_ids_path_attach, additional_owner_keys, additional_user_keys, research_environment, additional_security_group_ids, slurm_version, metadata_token, metadata_endpoint):
        ...
        """
        self.send_start_server(flavor_name, image_name, public_key, servername, metadata, volume_ids_path_new, volume_ids_path_attach, additional_owner_keys, additional_user_keys, research_environment, additional_security_group_ids, slurm_version, metadata_token, metadata_endpoint)
        return self.recv_start_server()

    def send_start_server(self, flavor_name, image_name, public_key, servername, metadata, volume_ids_path_new, volume_ids_path_attach, additional_owner_keys, additional_user_keys, research_environment, additional_security_group_ids, slurm_version, metadata_token, metadata_endpoint):
    ...
    def start_server_with_custom_key(self, flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids, additional_owner_keys, additional_user_keys, metadata_token, metadata_endpoint):
        ...
        """
        self.send_start_server_with_custom_key(flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids, additional_owner_keys, additional_user_keys, metadata_token, metadata_endpoint)
        return self.recv_start_server_with_custom_key()

    def send_start_server_with_custom_key(self, flavor_name, image_name, servername, metadata, research_environment, volume_ids_path_new, volume_ids_path_attach, additional_security_group_ids, additional_owner_keys, additional_user_keys, metadata_token, metadata_endpoint):
...
class Processor(Iface, TProcessor):
    ...
    def process_start_cluster(self, seqid, iprot, oprot):
        ...
        result = start_cluster_result()
        try:
            result.success = self._handler.start_cluster(args.public_keys, args.master_instance, args.worker_instances)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
...
class start_server_with_custom_key_args(object):
    ...
    def __init__(self, flavor_name = None, image_name = None, servername = None, metadata = None, research_environment = None, volume_ids_path_new = None, volume_ids_path_attach = None, additional_security_group_ids = None, additional_owner_keys = None, additional_user_keys = None, metadata_token = None, metadata_endpoint = None,):
        self.flavor_name = flavor_name
        self.image_name = image_name
        self.servername = servername
        self.metadata = metadata
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i349 in range(_size345):
                        _elem350 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.names.append(_elem350)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i372 in range(_size368):
                        ...
                        self.base_tags.append(_elem373)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
...
class start_cluster_args(object):
    ...
    def __init__(self, public_keys = None, master_instance = None, worker_instances = None,):
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i388 in range(_size384):
                        ...
                        self.public_keys.append(_elem389)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i394 in range(_size390):
                        _elem395 = ClusterWorker()
                        _elem395.read(iprot)
                        self.worker_instances.append(_elem395)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.public_keys is not None:
            ...
            for iter396 in self.public_keys:
...
class create_volume_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter414, viter415 in self.metadata.items():
...
class create_volume_by_source_volume_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter423, viter424 in self.metadata.items():
                oprot.writeString(kiter423.encode('utf-8') if sys.version_info[0] == 2 else kiter423)
                oprot.writeString(viter424.encode('utf-8') if sys.version_info[0] == 2 else viter424)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class create_volume_by_volume_snap_args(object):
    ...
    def write(self, oprot):
        ...
        if self.metadata is not None:
            oprot.writeFieldBegin('metadata', TType.MAP, 2)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.metadata))
            for kiter432, viter433 in self.metadata.items():
