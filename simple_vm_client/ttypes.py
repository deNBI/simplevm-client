...
class ComponentHealth(object):
    ...
    def write(self, oprot):
        ...
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            ...
            return
        oprot.writeStructBegin("ComponentHealth")
        if self.activated is not None:
            oprot.writeFieldBegin("activated", TType.BOOL, 1)
            oprot.writeBool(self.activated)
            oprot.writeFieldEnd()
        if self.healthy is not None:
            oprot.writeFieldBegin("healthy", TType.BOOL, 2)
            oprot.writeBool(self.healthy)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
all_structs.append(ComponentHealth)
ComponentHealth.thrift_spec = (
    None,  # 0
    (
        1,
        TType.BOOL,
