...
class MetadataUser(object):
    ...
    def __init__(self, user_id=None, public_keys=None, unix_name=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.unix_name = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.unix_name is not None:
            ...
            oprot.writeString(self.unix_name.encode('utf-8') if sys.version_info[0] == 2 else self.unix_name)
            oprot.writeFieldEnd()
...
class Image(object):
    ...
    def __init__(self, name=None, min_disk=None, min_ram=None, status=None, created_at=None, updated_at=None, openstack_id=None, description=None, tags=None, is_snapshot=None, os_version=None, os_distro=None, title=None, slurm_version=None,):
        self.name = name
...
class ClusterVolume(object):
    ...
    def __init__(self, openstack_id=None, permanent=None, exists=None, size=None, type="ext4",):
        self.openstack_id = openstack_id
...
class ClusterWorker(object):
    ...
    def __init__(self, type=None, image=None, count=None, onDemand=False,):
        self.type = type
        self.image = image
        self.count = count
...
class ClusterMessage(object):
    ...
    def __init__(self, message=None, cluster_id=None,):
...
class ClusterInfo(object):
    ...
    def __init__(self, message=None, cluster_id=None, ready=None,):
        self.message = message
        self.cluster_id = cluster_id
        self.ready = ready
...
class ClusterState(object):
    ...
    def __init__(self, cluster_id=None, message=None, state=None, ssh_user=None, floating_ip=None, last_changed=None,):
        self.cluster_id = cluster_id
        self.message = message
        self.state = state
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.ssh_user = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
                ...
                if ftype == TType.STRING:
                    self.last_changed = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.last_changed is not None:
            ...
            oprot.writeString(self.last_changed.encode('utf-8') if sys.version_info[0] == 2 else self.last_changed)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ClusterLog(object):
    ...
    def __init__(self, message=None, cluster_id=None, log=None,):
        self.message = message
        self.cluster_id = cluster_id
        self.log = log
...
MetadataUser.thrift_spec = (
    ...
    (2, TType.LIST, 'public_keys', (TType.STRING, 'UTF8', False), None, ),  # 2
    (3, TType.STRING, 'unix_name', 'UTF8', None, ),  # 3
)
all_structs.append(MetadataUserData)
MetadataUserData.thrift_spec = (
    None,  # 0
    None,  # 1
    (2, TType.MAP, 'data', (TType.STRING, 'UTF8', TType.STRUCT, [MetadataUser, None], False), {
    }, ),  # 2
)
...
VirtualMachineServerMetadata.thrift_spec = (
    ...
    (3, TType.STRUCT, 'userdata', [MetadataUserData, None], None, ),  # 3
)
...
Image.thrift_spec = (
    ...
    (14, TType.STRING, 'slurm_version', 'UTF8', None, ),  # 14
)
...
ClusterInstanceMetadata.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'user_id', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'project_id', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'project_name', 'UTF8', None, ),  # 3
)
...
ClusterVolume.thrift_spec = (
    ...
    (2, TType.BOOL, 'permanent', None, None, ),  # 2
    (3, TType.BOOL, 'exists', None, None, ),  # 3
    (4, TType.I32, 'size', None, None, ),  # 4
    (5, TType.STRING, 'type', 'UTF8', "ext4", ),  # 5
)
...
ClusterWorker.thrift_spec = (
    ...
    (4, TType.BOOL, 'onDemand', None, False, ),  # 4
)
all_structs.append(ClusterMessage)
ClusterMessage.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'message', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'cluster_id', 'UTF8', None, ),  # 2
)
...
ClusterInfo.thrift_spec = (
    ...
    (1, TType.STRING, 'message', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'cluster_id', 'UTF8', None, ),  # 2
    (3, TType.BOOL, 'ready', None, None, ),  # 3
)
...
ClusterState.thrift_spec = (
    ...
    (4, TType.STRING, 'ssh_user', 'UTF8', None, ),  # 4
    (5, TType.STRING, 'floating_ip', 'UTF8', None, ),  # 5
    (6, TType.STRING, 'last_changed', 'UTF8', None, ),  # 6
)
